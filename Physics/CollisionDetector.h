...
#define sgn(a)                                      ((a) > 0 ? 1 : ( (a) < 0 ? -1 : 0 ));
    ...
    int  CheckPlanes(xVector3 *a1, xVector3 *a2, xVector3 *a3, xVector3 *b1, xVector3 *b2, xVector3 *b3)
    {
...
/*
        float X = det3(a1->y, a1->z, 1.f,
                       a2->y, a2->z, 1.f,
                       a3->y, a3->z, 1.f);
        float Y = det3(a1->x, a1->z, 1.f,
                       a2->x, a2->z, 1.f,
                       a3->x, a3->z, 1.f);
        float Z = det3(a1->x, a1->y, 1.f,
                       a2->x, a2->y, 1.f,
                       a3->x, a3->y, 1.f);
        float W = det3(a1->x, a1->y, a1->z,
                       a2->x, a2->y, a2->z,
                       a3->x, a3->y, a3->z);
...
*/
    ...
    bool IntersectTriangles(xVector3 *a1, xVector3 *a2, xVector3 *a3, xVector3 *b1, xVector3 *b2, xVector3 *b3, xVector3 *crossing)
    {
        ...
        for (int h1 = cnt1; h1; --h1, ++chb1, ++ch1)
        {
            ...
            for (int h2 = cnt2; h2; --h2, ++chb2, ++ch2)
                    ...
                    chb1->bounding.max.z > chb2->bounding.min.z)
                {
                    ...
                    xBox *faceB1 = chb1->faceBoundings;
                    for (int i1 = ch1->facesC; i1; --i1, ++faceB1)
                    {
                        xBox *faceB2 = chb2->faceBoundings;
                        for (int i2 = ch2->facesC; i2; --i2, ++faceB2)
                        {
